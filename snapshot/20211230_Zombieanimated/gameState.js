...
let startGameLoop =  function () {
  ...
  //let GameLoop = function ()  {
    if (number < 100) {
      ...
      //drawSprite(imagesX.player, playerWidth * playerFrameX, playerHeight * playerFrameY, playerWidth, playerHeight, playerX, playerY, playerWidth, playerHeight);
      player_.update()
      //ctx_back.drawImage(imagesX.player, 0, 0 , 100,100);
